...
// let month:string | null = await this.page.locator(this.dateOfTheMonth).locator('[selected="selected"]').textContent()
// console.log(year);
// console.log(month);
// console.log(this.date);
// await this.page.locator(this.dateFromComponent).getByRole('link',{name: this.date, exact:true}).click()
// expect(await this.page.locator(this.fromInput).inputValue()).toBe(`${obj[month]}/${this.date}/${year}`)//mm/dd/yyyy
